...
..  literalinclude:: ExampleWebsitetitle/_WebsiteTitleProvider.php
...
..  literalinclude:: ExampleWebsitetitle/_Services.yaml
...
..  literalinclude:: ExampleWebsitetitle/_setup.typoscript
    :caption: EXT:my_sitepackage/Configuration/TypoScript/setup.typoscript

The first page title provider that sets the page title to an empty value is
used. Therefore our custom provider should be loaded before `record`, the
